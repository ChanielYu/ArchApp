...
data class WeatherModel(@SerializedName("currently")
                        ...
                        val timezone: String?) {
    data class Currently(@SerializedName("apparentTemperature")
    ...
    data class Daily(@SerializedName("data")
                     val `data`: List<Data?>?,
                     @SerializedName("icon")
                     val icon: String?,
                     @SerializedName("summary")
    ...
    data class Data(@SerializedName("apparentTemperatureHigh")
    ...
    data class Hourly(@SerializedName("data")
                      val `data`: List<DataX?>?,
                      @SerializedName("icon")
                      val icon: String?,
                      @SerializedName("summary")
    ...
    data class DataX(@SerializedName("apparentTemperature")
                     val apparentTemperature: Double?,
                     @SerializedName("cloudCover")
                     val cloudCover: Double?,
                     @SerializedName("dewPoint")
